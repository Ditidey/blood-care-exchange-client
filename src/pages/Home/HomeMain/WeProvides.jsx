            ...
            <div className='grid md:grid-cols-4 gap-6 pt-40 md:pt-0'>
                 ...
                 <div className='py-3 shadow-xl rounded-md' data-aos="zoom-in-up" data-aos-duration="3000">
                    ...
                    <div className=''>
                        ...
                        <p className='text-justify my-3 px-8'>Blood consultancy typically refers to a specialized service or expertise provided by healthcare professionals or organizations that focus on blood-related matters</p>
                        <Link to=' ' className='text-blue-700 text-sm me-20 mb-3 px-10'>Learn more..</Link>
                 ...
                 <div className='py-3 shadow-xl rounded-md' data-aos="zoom-in-up" data-aos-duration="3000">
                    ...
                    <div className=' '>
                        ...
                        <p className='text-justify my-3 px-8 mb-6'>Blood transfusion is a medical procedure that involves the infusion of donated blood, transfusion reactions, managing complications, and ensuring transfusion safety.</p>
                        <Link to='/blood-trans' className='text-blue-700 text-sm me-20 mb-5 ms-8'>Learn more..</Link>
                 ...
                 <div className='py-3 shadow-xl rounded-md' data-aos="zoom-in-left" data-aos-duration="3000">
                    ...
                    <div className=' '>
                        ...
                        <p className='text-justify my-3 px-8 mb-9'> To develop new testing methodologies, improve blood product safety, or contribute to scientific publications.</p>
                        <Link to=' ' className='text-blue-700 text-sm me-20 mb-3 ps-8'>Learn more..</Link>
