            ...
            <div className='grid md:grid-cols-4 gap-6  md:pt-0'>
                 ...
                 <div className='py-3 shadow-xl rounded-md' data-aos="zoom-in-right" data-aos-duration="3000">
                    ...
                    <div className='md:px-8 px-2 pb-10 md:pb-0'>
                        ...
                        <Link to='/test-book' className='text-blue-700 text-sm shadow-md p-2 hover:bg-red-600 ms-8 rounded-md mt-3'>Book now</Link>
                    </div>
                 </div>
                 <div className='py-3 shadow-xl rounded-md' data-aos="zoom-in-up" data-aos-duration="3000">
                    ...
                    <div className='  pb-5 md:pb-0'>
                        ...
                        <Link to='/treat-learn' className='text-blue-700 text-sm me-20 mb-3 md:px-10 px-5'>Learn more..</Link>
                        <Link to='/all-treatment' className='text-blue-700 text-sm shadow-md p-2 ps-1 hover:bg-red-600 mb-3 rounded-md'>Book now</Link>
                    </div>
                 </div>
                 <div className='py-3 shadow-xl rounded-md' data-aos="zoom-in-up" data-aos-duration="3000">
                    ...
                    <div className=' pb-5 md:pb-0'>
                        ...
                        <Link to='/auth-layout/become-donor' className='text-blue-700 text-sm shadow-md p-2 hover:bg-red-600 ms-8 mb-5 rounded-md'>Book now</Link>
                    </div>
                 </div>
                 <div className='py-3 shadow-xl rounded-md' data-aos="zoom-in-left" data-aos-duration="3000">
                    ...
                    <div className=' pb-5 md:pb-0'>
                        ...
                        <Link to='/research' className='text-blue-700 text-sm me-20 mb-3 md:ps-8 ps-2'>Learn more..</Link>
                        <Link to='/research' className='text-blue-700 text-sm shadow-md p-2 hover:bg-red-600 ms-8 mb-3 rounded-md'>Book now</Link>
                    </div>
                 </div>
            </div>
        </div>
